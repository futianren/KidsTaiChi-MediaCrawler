...
# Repository: https://github.com/futianren/KidsTaiChi-MediaCrawler/blob/main/proxy/providers/wandou_http_proxy.py
    ...
    async def get_proxy(self, num: int) -> List[IpInfoModel]:
        ...
        async with make_async_client() as client:
            ...
            response = await client.get(
                url,
                headers={
                    "User-Agent": "MediaCrawler https://github.com/futianren/KidsTaiChi-MediaCrawler",
                },
            )
